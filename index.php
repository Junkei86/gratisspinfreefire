     ...
     <div class="alertx">
        ...
        <div class="alertl">
            <div class="topl">LOGIN TO YOUR ACCOUNT</div>
                ...
                <div class="tw" onclick="tw()"><i class="fa fa-vk" aria-hidden="true"></i>Login With VK</div>
        </div>
...
<div class="footer">
    <div class="foot_ct">
        <p class="foot_icon">
            ...
            <a onclick="gtag('event', 'x_jump', {'event_category': 'website','event_label': 'pc_footer_twitter'});" href="https://twitter.com/PUBGMOBILE" class="foot_icon2" target="_blank">VK</a>
